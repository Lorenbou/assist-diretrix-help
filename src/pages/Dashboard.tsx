    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          <Select value={typeFilter} onValueChange={(value) => setTypeFilter(value as 'question' | 'bug' | 'all')}>
          ...
          <Select value={statusFilter} onValueChange={(value) => setStatusFilter(value as 'open' | 'in_progress' | 'closed' | 'all')}>  
            <SelectTrigger className="w-full md:w-40">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        <span>Por: <span className="font-medium">{ticket.created_by_user?.name || 'Usuário'}</span></span>
                        <span>•</span>
